 ...
 *
 * The queryType 'QueryEventType' describes the structure we see later on in the Dynamic Source Settings
 *
...
class SourceListener
{
    ...
    public static function initSource($source)
    {
        ...
        $source->queryType(QueryEventType::config());
        $source->queryType(QueryEventsType::config());
    }
}
